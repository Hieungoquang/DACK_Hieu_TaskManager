...
class ActiveTaskTrackerWidget extends StatefulWidget {
  ...
  @override
  State<ActiveTaskTrackerWidget> createState() => _ActiveTaskTrackerWidgetState();
}
...
class _ActiveTaskTrackerWidgetState extends State<ActiveTaskTrackerWidget> {
  ...
  void _updateTime() {
    ...
    if (now.isAfter(widget.task.deadline)) {
      ...
      final total = widget.task.deadline.difference(widget.task.due_day).inSeconds;
      if (total <= 0) {
        _timeProgress = 0.0;
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _isOverdue ? Colors.redAccent.withOpacity(0.6) : borderColor, width: 1.5),
        boxShadow: [
          BoxShadow(
            color: (_isOverdue ? Colors.redAccent : ghOrange).withOpacity(0.08),
            blurRadius: 15,
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: (_isOverdue ? Colors.redAccent : ghOrange).withOpacity(0.15),
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      _isOverdue ? Icons.warning_amber_rounded : Icons.bolt_rounded,
                      color: _isOverdue ? Colors.redAccent : ghOrange,
                      size: 14,
                    ),
                    const SizedBox(width: 4),
                    Text(
                      _isOverdue ? "ĐÃ HẾT KHUNG GIỜ" : "ĐANG THỰC HIỆN",
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      _isOverdue ? "Thời gian trễ hạn" : "Thời gian còn lại",
                      style: GoogleFonts.nunito(
                        fontSize: 12,
                        color: subText,
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation(_isOverdue ? Colors.redAccent : ghOrange),
            ),
          ),
        ],
      ),
